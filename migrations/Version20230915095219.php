 ...
 */
final class Version20230915095219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE experience (id VARCHAR(255) NOT NULL, company_id VARCHAR(255) NOT NULL, employee_id VARCHAR(3) DEFAULT NULL, trainee_id VARCHAR(3) DEFAULT NULL, start_date DATE NOT NULL, end_date DATE DEFAULT NULL, fixed_term TINYINT(1) NOT NULL, role VARCHAR(255) NOT NULL, generic_summary LONGTEXT NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_590C103979B1AD6 (company_id), INDEX IDX_590C1038C03F15C (employee_id), INDEX IDX_590C10336C682D0 (trainee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE person (id VARCHAR(3) NOT NULL, person_id VARCHAR(3) DEFAULT NULL, full_name VARCHAR(255) NOT NULL, position VARCHAR(255) DEFAULT NULL, birth_date DATE DEFAULT NULL, phone VARCHAR(17) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, nationality VARCHAR(255) DEFAULT NULL, marital_status VARCHAR(255) DEFAULT NULL, summary LONGTEXT DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, street VARCHAR(255) DEFAULT NULL, postal_code VARCHAR(7) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, INDEX IDX_34DCD176217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE realisation (id INT AUTO_INCREMENT NOT NULL, experience_id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, link VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, importance INT NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_EAA5610E46E90E27 (experience_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE skill (name VARCHAR(255) NOT NULL, root_id VARCHAR(255) DEFAULT NULL, parent_id VARCHAR(255) DEFAULT NULL, selectable TINYINT(1) NOT NULL, lft INT NOT NULL, rgt INT NOT NULL, lvl INT NOT NULL, INDEX IDX_5E3DE47779066886 (root_id), INDEX IDX_5E3DE477727ACA70 (parent_id), PRIMARY KEY(name)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE technology (version VARCHAR(255) NOT NULL, skill_name VARCHAR(255) NOT NULL, realisation_id INT NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_F463524D1962E2B4 (skill_name), INDEX IDX_F463524DB685E551 (realisation_id), PRIMARY KEY(version, skill_name, realisation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE technology ADD CONSTRAINT FK_F463524D1962E2B4 FOREIGN KEY (skill_name) REFERENCES skill (name)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task DROP FOREIGN KEY FK_527EDB25B685E551');
        $this->addSql('ALTER TABLE task_translation DROP FOREIGN KEY FK_F21CE85D8DB60186');
        $this->addSql('ALTER TABLE technology DROP FOREIGN KEY FK_F463524D1962E2B4');
